export function getWeatherbyCity (input, unit) {    
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${input}&units=${unit}&appid=5930db5d44bec417fea8ad03d7d4747b`
    return fetch(url)
